        ...
        <>
            <AppBar position="static" sx={{ backgroundColor: "#1976D2" }}>
                <Toolbar sx={{ justifyContent: "space-between" }}>
                    ...
                    <IconButton size="large" edge="end" color="inherit" onClick={handleLogoutClick}>
                        <Logout />
                    </IconButton>
                    <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleLogoutClose}>
            ...
            <Box sx={{ backgroundColor: "#f5f5f5", padding: "20px" }}>
                ...
                <Box display={"flex"} margin={1} flexDirection={"row"} gap={2} flexWrap={"wrap"}>
                ...
                <CardContent>
                    ...
                    {feedback && (
                        <Typography variant="body2">
                            {" "}
                            <b>Patient's Feedback: </b> {feedback}
                        </Typography>
                    )}
